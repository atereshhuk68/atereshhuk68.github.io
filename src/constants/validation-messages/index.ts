...
export const ValidationMessages = {
  en: {
    ...
    PHONE_INCOMPLETE: "Please complete the phone number",
  ...
  uk: {
    ...
    PHONE_INCOMPLETE: "Будь ласка, заповніть номер телефону повністю",
  ...
  pl: {
    ...
    PHONE_INCOMPLETE: "Proszę podać pełny numer telefonu",
  ...
  ru: {
    ...
    PHONE_INCOMPLETE: "Пожалуйста, введите полный номер телефона",
